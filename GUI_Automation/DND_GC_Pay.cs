...
namespace SeleniumTests
{
    ...
    public class DNDGCPay
    {
        ...
        public void TheDNDGCPayTest()
        {
            ...
            // ERROR: Caught exception [ERROR: Unsupported command [clickAt | id=BUTTON11 | ]]
            // Payment Information
            driver.FindElement(By.XPath("//div[@id='#2K2NB']/input")).SendKeys("16");
            ...
            driver.FindElement(By.Id("#1P6CD")).SendKeys("184562418550");
